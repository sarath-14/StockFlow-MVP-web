...
const AppInput = (props: AppInputProps) => {
    return (
        <div className={"flex flex-col gap-2 justify-center items-start " + props.className}>
            <div className="text-md">{ props.label }</div>
            <div className="border border-amber-50 justify-center items-center min-w-30 w-full rounded-lg ">
